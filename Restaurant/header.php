...
<div id="phpRestaurantPreloader">
	<div class="phprestaurant_loader">
		<img src="<?php echo $CONF['installation_path']; ?>skin/images/Preloader_2.gif">
	</div>
</div>
			...
			<div class="modal-body">
				<form action="" id="update-users-informations" class="sends_catering_order" method="POST">
					...
					<div class="label_input_group">
						...
						<input required class="col-md-8 form-control" type='text' name='order_address' placeholder="<?php echo $lang['cp_order_address']; ?>" value="<?php if (loggedIn()) { echo $user_delivery_address; } ?>" />
					</div>
					<div class="label_input_group">
					...
					<div class="label_input_group">
						...
						<input required class="form-control" type='text' id="usr_email1" name='order_user_email' placeholder="<?php echo $lang['cp_settings_restaurant_email_eg']; ?>" value="<?php if (loggedIn()) { echo $order_user_email; } ?>" ><br/>
					</div>
					<div class="label_input_group">
						<label><?php echo $lang['Phone_number']; ?></label>
						<input required class="col-md-8 form-control" type='text' id="order_phone1" name='order_user_phone' placeholder="<?php echo $lang['cp_settings_restaurant_phone_eg']; ?>" value="<?php if (loggedIn()) { echo $order_user_phone; } ?>" ><br/>
					</div>
					<div class="label_input_group">
...
<!-- 					<input type="hidden" name="rm" value="2">
					...
					<input type="hidden" name="usr_phone" id="order_phone2" value="<?php if (loggedIn()) { echo $order_user_phone; } ?>">
					<input type="hidden" name="usr_email" id="usr_email2" value="<?php if (loggedIn()) { echo $order_user_email; } ?>">
