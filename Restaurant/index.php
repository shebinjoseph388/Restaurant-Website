...
<div class="restaurant-full-width block-menu block-book-a-table block-catering row">
	<div class="container">
		<div class="row">
			<div class="col-md-4"><?php include ($currentDirectory . '/page/menus/block-menus.php'); ?></div>
			<div class="col-md-4"><?php include ($currentDirectory . '/page/book-a-table/block-book-a-table.php'); ?></div>
			<div class="col-md-4"><?php include ($currentDirectory . '/page/catering/block-catering.php'); ?></div>
		</div>
	</div>
</div>
