			...
			<div class="col-md-12">
				...
				<?php if ($query2['user_role'] == 'Administrator') { ?>
					...
					if(isset($_POST["submit_edit_table"])){
						...
						$query_edit_menu = "UPDATE tables SET restaurant_room_nr='$restaurant_room_nr',table_css_position_top='$table_css_position_top',table_css_position_left='$table_css_position_left', table_details='$table_details', table_number_of_places='$table_number_of_places', table_position='$table_position' WHERE table_id='$table_id'";
						mysqli_query($con, $query_edit_menu); ?>
