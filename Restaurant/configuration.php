...
$CONF['user'] = 'root';
$CONF['pass'] = '';
$CONF['name'] = 'phprestaurant';


// The Installation URL path
$CONF['installation_path'] = 'http://localhost/phprestaurant/';
// The Server path
$CONF['server_path'] = dirname(__FILE__);
// Restaurant Favicon
$CONF['favicon_url'] = $CONF['installation_path'] . 'skin/images/favicon.png';
// Restaurant Logo
$CONF['logo_url'] = $CONF['installation_path'] . 'skin/images/l2.png';
